...
type Provider interface {
	...
	GetControlPlaneCertSecret(ctx context.Context, values providers.Values) (*capiYaml.InitFile, error)
	...
	GetControlPlaneCertFiles(ctx context.Context, values providers.Values) ([]capiYaml.InitFile, error)
	...
	GetKubeconfig(ctx context.Context, values providers.Values) (*capiYaml.InitFile, error)
}
